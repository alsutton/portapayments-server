...
<title>PortaPayments - Payment Completed</title>
</head>
<body style="background: #eeeeff; margin: 0px; font-family: verdana, sans-serif">
...
admobRequiredParams.put("PUBLISHER_ID", "a14b4b1f03ace0c"); // Required to request ads. To find your Publisher ID, log in to your AdMob account and click on the "Sites & Apps" tab.
